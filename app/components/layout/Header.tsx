...
export function Header() {
  return (
    <header className="container mx-auto max-w-5xl px-6 pb-8 pt-10 sm:px-9 sm:pt-12 flex w-full items-center">
      <NavLink
        to="/"
        end
      ...
      >
        <img src="/logo.svg" alt="" width="76" height="98" className="h-auto w-5" />
        harmen.dev
      </NavLink>
      <nav
        aria-label="Primary"
