        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    class="block rounded-md border border-border bg-card px-4 py-4 shadow-md shadow-gray-50 dark:shadow-black transition hover:border-primary hover:opacity-85 hover:shadow-gray-200 hover:-translate-y-1 dark:hover:shadow-black sm:px-5"
